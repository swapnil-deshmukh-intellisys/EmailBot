...
function rowFromLog(item = {}, campaign = {}) {
  ...
  return {
    ...
    'Original Sent': item.sentCount > 0 ? 'Yes' : 'No',
    'Reminder Sent': item.reminderSentCount || 0,
    'Reply Sent': item.manualReplySentCount || 0,
    'Reply All Sent': item.replyAllSentCount || 0,
    'Last Follow-up Date': item.lastFollowUpAt || '',
    'Thread Status': item.threadStatus || (item.sentCount > 0 ? 'Original Sent' : ''),
